...
<Preview>
  <Story id="core-components-schedule-group--basic-usage" />
</Preview>
...
<Preview>
  <Story id="core-components-schedule-group--with-leading-space" />
</Preview>
...
<Preview>
  <Story id="core-components-schedule-group--with-extra-rows" />
</Preview>

## Vertical 

When you want to change the calendar to a vertical orientation you can set the prop `vertical` to 
be true. Internally this sets the flex direction to row instead of column but this can be used to 
build a mobile friendly calendar. 

<Preview>
  <Story id="core-components-schedule-group--with-vertical-orientation" />
</Preview>
